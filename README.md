## 🐒 Monkey Tools (Work in Progress)

- toolbox built for nerds by an old nerd
...
- monkey limewire (monkey.mp3.exe will launch malwarebytes and chaos monkey)

- monkey parse (bundle previous warehouse parser)

- monkey gun (youll see)
